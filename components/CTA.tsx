      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        >
          <div className="glass px-6 py-14 sm:px-12 sm:py-16">
            <h2 className="text-3xl font-semibold tracking-[-0.05em] text-white md:text-5xl lg:text-6xl">
              Ready to grow with <span className="gradient-text">Advora?</span>
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-zinc-400 sm:text-lg">
              Everything your marketing team needs. One AI-powered workspace.
            </p>
