...
function FeedbackToast({
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 right-4 z-[100] w-[calc(100%-2rem)] sm:bottom-6 sm:right-6 sm:w-auto">
      <AnimatePresence>
        {toast && (
          <motion.div
...
export default function BetaLaunchBanner() {
  ...
  function openFeedbackModal(category: FeedbackCategory) {
